class LivrosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @livro.save
        format.html { redirect_to livro_url(@livro), notice: "Uma review de ivro foi adicionada com sucesso." }
  ...
  def update
    respond_to do |format|
      if @livro.update(livro_params)
        format.html { redirect_to livro_url(@livro), notice: "A review do livro foi alterada com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to livros_url, notice: "A review do livro foi deletada." }
